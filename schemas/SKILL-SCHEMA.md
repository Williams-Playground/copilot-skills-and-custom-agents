...
The body should follow this recommended structure.
...
└── Recommended Markdown Body
    ├── ## Step N: ... — step-by-step instructions
    ├── ## Inputs — inputs needed from user
    ├── ## Output Structure — what the skill produces
    ├── ## Rules — constraints and non-negotiable behaviors
    ├── ## Examples — input/output demonstrations
    ├── ## Validation Checklist  — self-verification
